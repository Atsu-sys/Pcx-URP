        ...
        void OnRenderObject()
        {
            ...
            if (_pointMaterial == null)
            {
                ...
                if (_pointShader == null)
                    _pointShader = Shader.Find("Point Cloud/Point URP");
                if (_diskShader == null)
                    _diskShader = Shader.Find("Point Cloud/Disk URP");

                if (_pointShader == null || _diskShader == null)
                {
                    Debug.LogError("PCX: Could not find Point Cloud shaders. Make sure 'Point Cloud/Point URP' and 'Point Cloud/Disk URP' shaders exist.");
                    return;
                }
